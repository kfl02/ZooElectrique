...
public class Configuration {
	...
	public static Configuration makeConfiguration(PApplet app, String filename){
		File file = (IDE == ECLIPSE) ? new File("data/" + filename) : new File(app.dataPath("") +"/" + filename);
	...
	public class InputConfig {
		...
		public InputConfig(String line){
			...
			try {
			    type = InputType.valueOf(Integer.parseInt(part[2]));
			} catch(NumberFormatException e) {
			    type = InputType.valueOf(part[2]);
			}
