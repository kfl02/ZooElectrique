...
This is the readme for ZooElectrique, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. ZooElectrique) > Ok.
...
- To run the project find ZooElectrique.java (which will be in under src/main/java/nl/rumfumme) and right click > Run 'HelloAnybody'
